...
from cognigraph.ontology.skill_resolver import Skill

logger = logging.getLogger("cognigraph.ontology.skill_admin")
...
class SkillAdmin:
    ...
    def _try_init_titan(self) -> None:
        ...
        try:
            from cognigraph.activation.embeddings import TitanV2Engine
            titan = TitanV2Engine()
