"""MasterObserver — transparency intelligence layer for CogniGraph.
...
from cognigraph.core.observer_report import (
    AnomalyFlag,
    ConflictPair,
    NodeContribution,
    ObserverReport,
...
from cognigraph.core.types import ModelBackend, ReasoningType

if TYPE_CHECKING:
    from cognigraph.core.graph import CogniGraph

logger = logging.getLogger("cognigraph.observer")
