#!/bin/bash
# GraQle Governance Gate — blocks Claude Code native tools when graq_* equivalents exist.
# Installed by `graq gate-install`. Remove .claude/hooks/graqle-gate.sh to disable.
#
